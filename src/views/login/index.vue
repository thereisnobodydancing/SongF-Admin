<template>
  <div class="min-w-screen min-h-screen flex items-center justify-center px-5 py-5 bg-gradient-to-br from-white to-primary/10">
    <div class="bg-[rgba(255,255,255,0.5)] text-gray-500 rounded-3xl shadow-2xl shadow-primary/30 w-full overflow-hidden" style="max-width:900px">
      <div class="md:flex w-full">
        <div class="hidden md:block w-1/2 bg-primary py-10 px-10">
          <svg id="a87032b8-5b37-4b7e-a4d9-4dbfbe394641" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg"
            ...
            <path
              ...
              transform="translate(-227.576 -76.46149)" fill="#409EFF" />
        ...
        <div class="w-full md:w-1/2 py-14 px-10 md:px-14 bg-white/50">
          ...
          <div>
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                <label for="" class="text-xs font-semibold px-1">账号</label>
                <input v-model="form.mobile" placeholder="请输入您的账号"
                  class="w-full px-5 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-red-500">
              </div>
            </div>
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-12">
                <label for="" class="text-xs font-semibold px-1">密码</label>
                <input
            ...
            <div class="flex -mx-3">
              <div class="w-full px-3 mb-5">
                <button
                  class="block w-full max-w-xs mx-auto bg-primary/90 text-white rounded-lg px-3 py-3 font-bold hover:bg-primary disabled:opacity-70"
